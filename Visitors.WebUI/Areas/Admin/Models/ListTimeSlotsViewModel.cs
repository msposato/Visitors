...
{
  public class ListTimeSlotsViewModel
  {
    ...
    public ListTimeSlotsViewModel()
    {
      _years.Add(new SelectListItem { Text = "2010", Value = "2010" });
      _years.Add(new SelectListItem { Text = "2011", Value = "2011" });
      _years.Add(new SelectListItem { Text = "2012", Value = "2012" });
      _years.Add(new SelectListItem { Text = "2013", Value = "2013" });
      _years.Add(new SelectListItem { Text = "2014", Value = "2014" });
      _years.Add(new SelectListItem { Text = "2015", Value = "2015" });
      _years.Add(new SelectListItem { Text = "2016", Value = "2016" });
      _years.Add(new SelectListItem { Text = "2017", Value = "2017" });
      _years.Add(new SelectListItem { Text = "2018", Value = "2018" });
      ...
      TimeSlots = new HashSet<ClassVisitTimeSlotViewModel>();
    }
    ...
    public IEnumerable<ClassVisitTimeSlotViewModel> TimeSlots { get; set; }
  }
}